...
class DeepfakeResultService:
    ...
    def get_result(candidate_id):
        ...
        result = DeepfakeRepository.get_result(candidate_id)

        if not result:
            return {
                "success": False,
                "verification_status": "NOT_VERIFIED",
                "display_message": "Deepfake verification has not been performed",
            }
        ...
        if verification_status == "REAL":
            return {
                ...
                "display_message": "Candidate selfie appears genuine",
            }
        ...
        if verification_status == "FAKE":
            return {
                ...
                "fake_probability": fake_probability,
                "display_message": "Candidate selfie appears manipulated",
            }

        return {
            "success": False,
            "verification_status": "FAILED",
            "display_message": "Deepfake verification failed",
        }
