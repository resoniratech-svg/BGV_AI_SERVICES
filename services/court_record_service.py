...
from repositories.court_record_repository import (
    CourtRecordRepository
)
...
class CourtRecordService:
    ...
    def search_court_records(
        ...
        try:
            ...
            url = (
                f"{Config.INDIANKANOON_BASE_URL}"
                f"/search/"
            )
            ...
            headers = {
                ...
                "Authorization":
                f"Token {Config.INDIANKANOON_API_TOKEN}"
            }
