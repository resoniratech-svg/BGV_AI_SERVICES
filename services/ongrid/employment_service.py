...
from repositories.employment_repository import (
    ...
    def verify_employment(
        ...
        if not salary_slip:
            ...
            raise Exception(
                ...
                "Salary Slip OCR result not found."
        ...
        if not mobile_number:
            ...
            raise Exception(
                ...
                "Candidate mobile number not available."
        ...
        if consent.get(
            ...
            raise Exception(
                ...
                "Candidate has not given Employment consent."
        ...
        response = (
            ...
            OnGridClient.post(
                ...
                "/epfo-api/employment-history/fetch/v2",
        ...
        if not transaction_id:
            ...
            raise Exception(
                ...
                "Gridlines did not return transaction_id."
        ...
        if not request_id:
            ...
            raise Exception(
                ...
                "Gridlines did not return request_id."
        ...
        if not employment_request_id:
            ...
            raise Exception(
                ...
                "Unable to save Employment request."
        ...
        if EmploymentRepository.result_exists(

                employment_request_id

        ):

            EmploymentRepository.delete_existing_result(
        ...
        employment_result_id = (
            ...
            .save_result(
                ...
                profile.get("masked_aadhaar_number"),

                guardian_name=
                profile.get("guardian_name"),

                guardian_relation=
                profile.get("guardian_relation"),
        ...
        if not employment_result_id:
            ...
            raise Exception(
                ...
                "Unable to save Employment result."
        ...
        for history in histories:
            ...
            history_uan = history.get(

                "uan"

            )

            employment_data = history.get(
        ...
        establishment = employer_data.get(
