...
dilisense_bp = Blueprint("dilisense_bp", __name__)


@dilisense_bp.route("/watchlist/screen", methods=["POST"])
def screen_watchlist():
    ...
    try:
        ...
        result = AMLService.screen_watchlist(
            candidate_id=candidate_id, full_name=full_name, dob=dob, gender=gender
        )
