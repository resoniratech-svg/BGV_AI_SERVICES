...
from services.credit_bureau_verification_service import (
    CreditBureauVerificationService
)

from services.credit_bureau_result_service import (
    CreditBureauResultService
)
...
@credit_bureau_bp.route(
    "/credit-bureau/verify",
    methods=["POST"]
)
...
@credit_bureau_bp.route(
    ...
    "/credit-bureau/result/<int:candidate_id>",
    ...
    try:
        ...
        if not result:
            ...
            return jsonify({
                ...
                "message": "Credit Bureau result not found."
