...
bank_statement_callback_bp = Blueprint("bank_statement_callback", __name__)
...
@bank_statement_callback_bp.route("/bank-statement/callback", methods=["POST"])
def bank_statement_callback():
    ...
    try:
        ...
        result = BankStatementVerificationService.process_callback(
