...
from routes.face_match_routes import face_match_bp
from routes.credit_bureau_routes import credit_bureau_bp
from routes.consent_routes import consent_bp
from routes.ccrv_callback_routes import ccrv_callback_bp
from routes.ccrv_routes import ccrv_bp
...
from routes.bank_statement_callback_routes import bank_statement_callback_bp
...
app.register_blueprint(deepfake_bp, url_prefix="/api/v1")

app.register_blueprint(face_match_bp, url_prefix="/api/v1")
app.register_blueprint(credit_bureau_bp, url_prefix="/api/v1")
app.register_blueprint(consent_bp, url_prefix="/api/v1")
app.register_blueprint(ccrv_callback_bp, url_prefix="/api/v1")
app.register_blueprint(ccrv_bp, url_prefix="/api/v1")
app.register_blueprint(salary_slip_bp, url_prefix="/api/v1")
app.register_blueprint(employment_bp, url_prefix="/api/v1")
app.register_blueprint(bank_statement_bp, url_prefix="/api/v1/bank-statement")
app.register_blueprint(bank_statement_callback_bp, url_prefix="/api/v1")
